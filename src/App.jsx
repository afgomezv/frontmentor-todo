...
import { MonnIcon } from "./components/icon/MonnIcon";

const App = () => {
  return (
    <div className="min-h-screen bg-gray-300 bg-[url('./assets/bg-mobile-light.jpg')] bg-contain bg-no-repeat">
        ...
        <div className="rounded-md bg-white [&>article]:p-4">
          <article className="flex gap-4 border-b border-b-gray-400">
            ...
            <p className="grow text-gray-600">
              Complete online Javascript course in Blueeweb
            </p>
